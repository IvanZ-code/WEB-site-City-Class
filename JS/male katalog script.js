...
const gallery = document.getElementById('male_gallery');
 ...
 try {
    ...
    const searchInputFemale = document.getElementById('searchInputMale');
    searchInputFemale.addEventListener('input', () => {
      const query = searchInputFemale.value.toLowerCase().trim();
      document.querySelectorAll('#male_gallery .item').forEach((item, index) => {
