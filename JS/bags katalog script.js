...
const gallery = document.getElementById('bags_gallery');
 ...
 try {
    ...
    const searchInputFemale = document.getElementById('searchInputBags');
    searchInputFemale.addEventListener('input', () => {
      const query = searchInputFemale.value.toLowerCase().trim();
      document.querySelectorAll('#bags_gallery .item').forEach((item, index) => {
